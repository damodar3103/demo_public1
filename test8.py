...
for vm in result.data:
    ...
    # Get VM IP addresses using Compute Management Client
    vm_id = vm['id']
    try:
        ...
        host_vars['private_ip'] = private_ip
        ...
        host_vars['public_ip'] = public_ip

        # Use public IP for ansible_host if available, otherwise use private IP
        host_vars['ansible_host'] = public_ip if public_ip else private_ip
